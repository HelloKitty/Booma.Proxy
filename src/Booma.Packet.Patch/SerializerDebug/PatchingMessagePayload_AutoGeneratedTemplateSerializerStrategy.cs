...
namespace Booma.Proxy
{
    ...
    public partial class PatchingMessagePayload
    {
        ...
        {
            PatchingMessagePayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(PSOBBPatchPacketPayloadServer value, Span<byte> buffer, ref int offset)
        {
            PatchingMessagePayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// </summary>
    public sealed partial class PatchingMessagePayload_AutoGeneratedTemplateSerializerStrategy
        : BaseAutoGeneratedSerializerStrategy<PatchingMessagePayload_AutoGeneratedTemplateSerializerStrategy, PatchingMessagePayload>
    {
        /// <summary>
