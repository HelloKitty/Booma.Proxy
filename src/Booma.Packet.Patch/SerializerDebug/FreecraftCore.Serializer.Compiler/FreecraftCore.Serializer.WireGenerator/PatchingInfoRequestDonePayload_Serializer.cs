...
namespace Booma
{
	...
	public partial class PatchingInfoRequestDonePayload
	{
		...
		{
			PatchingInfoRequestDonePayload_Serializer.Instance.InternalRead(this, buffer, ref offset);
			return this;
		}

		public override void Write(PSOBBPatchPacketPayloadServer value, Span<byte> buffer, ref int offset)
		{
			PatchingInfoRequestDonePayload_Serializer.Instance.InternalWrite(this, buffer, ref offset);
		}
	}
}
...
namespace FreecraftCore.Serializer
{
	...
	/// </summary>
	public sealed partial class PatchingInfoRequestDonePayload_Serializer : BaseAutoGeneratedSerializerStrategy<PatchingInfoRequestDonePayload_Serializer, PatchingInfoRequestDonePayload>
	{
		/// <summary>
