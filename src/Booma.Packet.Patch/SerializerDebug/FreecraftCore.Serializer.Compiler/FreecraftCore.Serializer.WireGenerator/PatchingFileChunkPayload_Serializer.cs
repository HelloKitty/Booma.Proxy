...
namespace Booma
{
	...
	public partial class PatchingFileChunkPayload
	{
		...
		{
			PatchingFileChunkPayload_Serializer.Instance.InternalRead(this, buffer, ref offset);
			return this;
		}

		public override void Write(PSOBBPatchPacketPayloadServer value, Span<byte> buffer, ref int offset)
		{
			PatchingFileChunkPayload_Serializer.Instance.InternalWrite(this, buffer, ref offset);
		}
	}
}
...
namespace FreecraftCore.Serializer
{
	...
	/// </summary>
	public sealed partial class PatchingFileChunkPayload_Serializer : BaseAutoGeneratedSerializerStrategy<PatchingFileChunkPayload_Serializer, PatchingFileChunkPayload>
	{
		/// <summary>
