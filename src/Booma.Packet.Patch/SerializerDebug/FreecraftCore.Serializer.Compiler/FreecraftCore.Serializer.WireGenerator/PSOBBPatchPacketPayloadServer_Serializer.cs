...
namespace FreecraftCore.Serializer
{
            ...
            : BasePolymorphicAutoGeneratedSerializerStrategy<PSOBBPatchPacketPayloadServer_Serializer, PSOBBPatchPacketPayloadServer, UInt16>
    {
        protected override PSOBBPatchPacketPayloadServer CreateType(int key)
        {
            switch (key)
            {
                case (int)Booma.PatchNetworkOperationCode.PATCH_SEND_DONE:
                    return new PatchingDoneCommandPayload();
                case (int)Booma.PatchNetworkOperationCode.PATCH_FILE_INFO:
                    return new PatchingFileCheckRequestPayload();
                case (int)Booma.PatchNetworkOperationCode.PATCH_DATA_SEND:
                    return new PatchingFileChunkPayload();
                case (int)Booma.PatchNetworkOperationCode.PATCH_FILE_DONE:
                    return new PatchingFileDonePayload();
                case (int)Booma.PatchNetworkOperationCode.PATCH_FILE_SEND:
                    return new PatchingFilePatchPayload();
                case (int)Booma.PatchNetworkOperationCode.PATCH_INFO_FINISHED:
                    return new PatchingInfoRequestDonePayload();
                case (int)Booma.PatchNetworkOperationCode.PATCH_MESSAGE_TYPE:
                    return new PatchingMessagePayload();
                case (int)Booma.PatchNetworkOperationCode.PATCH_SEND_INFO:
                    return new PatchingPatchInfoPayload();
                case (int)Booma.PatchNetworkOperationCode.PATCH_LOGIN_TYPE:
                    return new PatchingReadyForLoginRequestPayload();
                case (int)Booma.PatchNetworkOperationCode.PATCH_REDIRECT_TYPE:
                    return new PatchingRedirectPayload();
                case (int)Booma.PatchNetworkOperationCode.PATCH_SET_DIRECTORY:
                    return new PatchingSetDirectoryPayload();
                case (int)Booma.PatchNetworkOperationCode.PATCH_START_LIST:
                    return new PatchingStartPatchPayload();
                case (int)Booma.PatchNetworkOperationCode.PATCH_ONE_DIR_UP:
                    return new PatchingUpOneDirectoryCommandPayload();
                case (int)Booma.PatchNetworkOperationCode.PATCH_WELCOME_TYPE:
