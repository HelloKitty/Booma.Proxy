...
namespace Booma.Proxy
{
    ...
    public partial class PatchingFileInformationDoneAckPayload
    {
        ...
        {
            PatchingFileInformationDoneAckPayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(PSOBBPatchPacketPayloadClient value, Span<byte> buffer, ref int offset)
        {
            PatchingFileInformationDoneAckPayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// </summary>
    public sealed partial class PatchingFileInformationDoneAckPayload_AutoGeneratedTemplateSerializerStrategy
            : BaseAutoGeneratedSerializerStrategy<PatchingFileInformationDoneAckPayload_AutoGeneratedTemplateSerializerStrategy, PatchingFileInformationDoneAckPayload>
    {
        /// <summary>
