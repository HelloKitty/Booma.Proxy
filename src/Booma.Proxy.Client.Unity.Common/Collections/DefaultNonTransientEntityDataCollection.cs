...
{
	public sealed class DefaultNonTransientEntityDataCollection : ICollection<IEntityCollectionRemovable>, INonTransientEntityDataRemovableEnumerable
	{
		private List<IEntityCollectionRemovable> InternalRemovableCollection { get; }

		public DefaultNonTransientEntityDataCollection()
		{
