...
namespace Booma.Proxy
{
		...
		where TPayloadType : class, TIncomingPayloadBaseType
	{
		...
		/// <inheritdoc />
		public async Task<bool> TryHandleMessage([NotNull] IClientMessageContext<TOutgoingPayloadType> context, [NotNull] PSOBBNetworkIncomingMessage<TIncomingPayloadBaseType> message)
		{
