...
namespace FreecraftCore.Serializer
{
    ...
    /// </summary>
    public sealed partial class PSOBBNetworkOutgoingMessage_AutoGeneratedTemplateSerializerStrategy
            : BaseAutoGeneratedSerializerStrategy<PSOBBNetworkOutgoingMessage_AutoGeneratedTemplateSerializerStrategy, PSOBBNetworkOutgoingMessage>
    {
        /// <summary>
        ...
        public override void InternalRead(PSOBBNetworkOutgoingMessage value, Span<byte> buffer, ref int offset)
        {
            ...
            value.Header = PSOBBPacketHeader_AutoGeneratedTemplateSerializerStrategy.Instance.Read(buffer, ref offset);
        ...
        {
            //Type: PSOBBNetworkOutgoingMessage Field: 1 Name: Header Type: PSOBBPacketHeader;
            PSOBBPacketHeader_AutoGeneratedTemplateSerializerStrategy.Instance.Write(value.Header, buffer, ref offset);
            //Type: PSOBBNetworkOutgoingMessage Field: 2 Name: Payload Type: Byte[];
