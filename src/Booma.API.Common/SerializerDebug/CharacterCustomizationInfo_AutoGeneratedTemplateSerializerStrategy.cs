...
namespace FreecraftCore.Serializer
{
    ...
    /// </summary>
    public sealed partial class CharacterCustomizationInfo_AutoGeneratedTemplateSerializerStrategy
        : BaseAutoGeneratedSerializerStrategy<CharacterCustomizationInfo_AutoGeneratedTemplateSerializerStrategy, CharacterCustomizationInfo>
    {
        /// <summary>
        ...
        public override void InternalRead(CharacterCustomizationInfo value, Span<byte> buffer, ref int offset)
        {
            ...
            value.HairColor = Vector3_UInt16_AutoGeneratedTemplateSerializerStrategy.Instance.Read(buffer, ref offset);
            //Type: CharacterCustomizationInfo Field: 7 Name: Proportions Type: Vector2;
            value.Proportions = Vector2_Single_AutoGeneratedTemplateSerializerStrategy.Instance.Read(buffer, ref offset);
        }
        ...
        public override void InternalWrite(CharacterCustomizationInfo value, Span<byte> buffer, ref int offset)
        {
            ...
            //Type: CharacterCustomizationInfo Field: 6 Name: HairColor Type: Vector3;
            Vector3_UInt16_AutoGeneratedTemplateSerializerStrategy.Instance.Write(value.HairColor, buffer, ref offset);
            //Type: CharacterCustomizationInfo Field: 7 Name: Proportions Type: Vector2;
            Vector2_Single_AutoGeneratedTemplateSerializerStrategy.Instance.Write(value.Proportions, buffer, ref offset);
        }
    }
}