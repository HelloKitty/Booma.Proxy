...
namespace FreecraftCore.Serializer
{
	...
	/// </summary>
	public sealed partial class PlayerCharacterDataModel_Serializer : BaseAutoGeneratedSerializerStrategy<PlayerCharacterDataModel_Serializer, PlayerCharacterDataModel>
	{
		/// <summary>
		...
		public override void InternalRead(PlayerCharacterDataModel value, Span<byte> buffer, ref int offset)
		{
			...
			//Type: PlayerCharacterDataModel Field: 6 Name: ClassRace Type: CharacterClass
			;
