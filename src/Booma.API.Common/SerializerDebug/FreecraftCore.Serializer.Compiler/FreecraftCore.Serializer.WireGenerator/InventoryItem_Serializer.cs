...
namespace FreecraftCore.Serializer
{
	...
	/// </summary>
	public sealed partial class InventoryItem_Serializer : BaseAutoGeneratedSerializerStrategy<InventoryItem_Serializer, InventoryItem>
	{
		/// <summary>
		...
		public override void InternalRead(InventoryItem value, Span<byte> buffer, ref int offset)
		{
			...
			//Type: InventoryItem Field: 3 Name: Flags Type: InventoryItemFlags
			;
			value.Flags = GenericPrimitiveEnumTypeSerializerStrategy<InventoryItemFlags, UInt32>.Instance.Read(buffer, ref offset);
		...
		public override void InternalWrite(InventoryItem value, Span<byte> buffer, ref int offset)
		{
			...
			//Type: InventoryItem Field: 3 Name: Flags Type: InventoryItemFlags
			;
			GenericPrimitiveEnumTypeSerializerStrategy<InventoryItemFlags, UInt32>.Instance.Write(value.Flags, buffer, ref offset);
			//Type: InventoryItem Field: 4 Name: ItemData1 Type: Byte[]
			;
