...
namespace FreecraftCore.Serializer
{
	...
	/// </summary>
	public sealed partial class LobbyCharacterData_Serializer : BaseAutoGeneratedSerializerStrategy<LobbyCharacterData_Serializer, LobbyCharacterData>
	{
		/// <summary>
		...
		public override void InternalRead(LobbyCharacterData value, Span<byte> buffer, ref int offset)
		{
			...
			//Type: LobbyCharacterData Field: 5 Name: Money Type: UInt32
			;
			value.Money = GenericTypePrimitiveSerializerStrategy<UInt32>.Instance.Read(buffer, ref offset);
			...
			//Type: LobbyCharacterData Field: 7 Name: unk3 Type: UInt64
			;
		...
		public override void InternalWrite(LobbyCharacterData value, Span<byte> buffer, ref int offset)
		{
			...
			//Type: LobbyCharacterData Field: 5 Name: Money Type: UInt32
			;
			GenericTypePrimitiveSerializerStrategy<UInt32>.Instance.Write(value.Money, buffer, ref offset);
			//Type: LobbyCharacterData Field: 6 Name: GuildCard Type: String
			;
		...
		private sealed class StaticTypedNumeric_Int32_232 : StaticTypedNumeric<Int32>
		{
			public sealed override Int32 Value => 232;
		}
