...
namespace FreecraftCore.Serializer
{
	...
	/// </summary>
	public sealed partial class CharacterCustomizationInfo_Serializer : BaseAutoGeneratedSerializerStrategy<CharacterCustomizationInfo_Serializer, CharacterCustomizationInfo>
	{
		/// <summary>
