...
namespace FreecraftCore.Serializer
{
        ...
        : BaseAutoGeneratedSerializerStrategy<PlayerCharacterDataModel_AutoGeneratedTemplateSerializerStrategy, PlayerCharacterDataModel>
    {
        ...
        public override void InternalRead(PlayerCharacterDataModel value, Span<byte> buffer, ref int offset)
        {
            ...
            value.GuildCard = FixedSizeStringTypeSerializerStrategy<ASCIIStringTypeSerializerStrategy, StaticTypedNumeric_Int32_16, ASCIIStringTerminatorTypeSerializerStrategy>.Instance.Read(buffer, ref offset);
            //Type: PlayerCharacterDataModel Field: 3 Name: unk3 Type: UInt32[];
        ...
        public override void InternalWrite(PlayerCharacterDataModel value, Span<byte> buffer, ref int offset)
        {
            ...
            //Type: PlayerCharacterDataModel Field: 2 Name: GuildCard Type: String;
            FixedSizeStringTypeSerializerStrategy<ASCIIStringTypeSerializerStrategy, StaticTypedNumeric_Int32_16, ASCIIStringTerminatorTypeSerializerStrategy>.Instance.Write(value.GuildCard, buffer, ref offset);
            //Type: PlayerCharacterDataModel Field: 3 Name: unk3 Type: UInt32[];
