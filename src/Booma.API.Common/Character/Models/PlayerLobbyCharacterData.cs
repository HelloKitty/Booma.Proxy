...
namespace Booma
{
	...
	/// </summary>
	[WireDataContract]
	public sealed class PlayerLobbyCharacterData
	{
		[WireMember(1)]
		...
		/// Serializer ctor.
		/// </summary>
		public PlayerLobbyCharacterData()
		{
