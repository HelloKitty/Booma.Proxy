...
namespace Booma.Proxy
{
	...
	/// </summary>
	[WireDataContract]
	[LoginServerPacketPayload(LoginNetworkOperationCodes.BLOCK_LIST_TYPE)]
	public sealed class LoginBlockListEventPayload : PSOBBLoginPacketPayloadServer, ISerializationEventListener
	{
