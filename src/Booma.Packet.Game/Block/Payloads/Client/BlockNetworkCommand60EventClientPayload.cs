...
namespace Booma.Proxy
{
	...
	public class BlockNetworkCommand60EventClientPayload : PSOBBGamePacketPayloadClient, ISub60CommandContainer
	{
		/// <summary>
		/// The subcommand.
		/// </summary>
		...
		//Serializer ctor
		protected BlockNetworkCommand60EventClientPayload()
		{
