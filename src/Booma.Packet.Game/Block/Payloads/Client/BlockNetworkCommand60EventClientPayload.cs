...
namespace Booma
{
	...
	public partial class BlockNetworkCommand60EventClientPayload : PSOBBGamePacketPayloadClient, ISub60CommandContainer
	{
		/// <summary>
		/// The subcommand.
		/// </summary>
		...
		/// Serializer ctor.
		/// </summary>
		public BlockNetworkCommand60EventClientPayload()
