...
namespace Booma.Proxy
{
    ...
    public partial class SharedMenuSelectionRequestPayload
    {
        ...
        {
            SharedMenuSelectionRequestPayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(PSOBBGamePacketPayloadClient value, Span<byte> buffer, ref int offset)
        {
            SharedMenuSelectionRequestPayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// </summary>
    public sealed partial class SharedMenuSelectionRequestPayload_AutoGeneratedTemplateSerializerStrategy
        : BaseAutoGeneratedSerializerStrategy<SharedMenuSelectionRequestPayload_AutoGeneratedTemplateSerializerStrategy, SharedMenuSelectionRequestPayload>
    {
        /// <summary>
