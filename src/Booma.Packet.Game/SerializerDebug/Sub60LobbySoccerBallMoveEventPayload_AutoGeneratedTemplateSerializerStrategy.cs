...
namespace Booma.Proxy
{
    ...
    public partial class Sub60LobbySoccerBallMoveEventPayload
    {
        ...
        {
            Sub60LobbySoccerBallMoveEventPayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(BaseSubCommand60 value, Span<byte> buffer, ref int offset)
        {
            Sub60LobbySoccerBallMoveEventPayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// </summary>
    public sealed partial class Sub60LobbySoccerBallMoveEventPayload_AutoGeneratedTemplateSerializerStrategy
            : BaseAutoGeneratedSerializerStrategy<Sub60LobbySoccerBallMoveEventPayload_AutoGeneratedTemplateSerializerStrategy, Sub60LobbySoccerBallMoveEventPayload>
    {
        /// <summary>
        ...
        public override void InternalRead(Sub60LobbySoccerBallMoveEventPayload value, Span<byte> buffer, ref int offset)
        {
            ...
            value.KickStartPosition = Vector2_Single_AutoGeneratedTemplateSerializerStrategy.Instance.Read(buffer, ref offset);
        ...
        public override void InternalWrite(Sub60LobbySoccerBallMoveEventPayload value, Span<byte> buffer, ref int offset)
        {
            ...
            //Type: Sub60LobbySoccerBallMoveEventPayload Field: 6 Name: KickStartPosition Type: Vector2;
            Vector2_Single_AutoGeneratedTemplateSerializerStrategy.Instance.Write(value.KickStartPosition, buffer, ref offset);
            //Type: Sub60LobbySoccerBallMoveEventPayload Field: 7 Name: UnknownBytes Type: Byte[];
