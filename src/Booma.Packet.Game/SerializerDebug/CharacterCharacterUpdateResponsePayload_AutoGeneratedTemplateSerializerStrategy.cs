...
namespace Booma.Proxy
{
    ...
    public partial class CharacterCharacterUpdateResponsePayload
    {
        ...
        {
            CharacterCharacterUpdateResponsePayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(PSOBBGamePacketPayloadServer value, Span<byte> buffer, ref int offset)
        {
            CharacterCharacterUpdateResponsePayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// </summary>
    public sealed partial class CharacterCharacterUpdateResponsePayload_AutoGeneratedTemplateSerializerStrategy
        : BaseAutoGeneratedSerializerStrategy<CharacterCharacterUpdateResponsePayload_AutoGeneratedTemplateSerializerStrategy, CharacterCharacterUpdateResponsePayload>
    {
        /// <summary>
