...
namespace Booma.Proxy
{
    ...
    public partial class CharacterOptionsRequestPayload
    {
        public override Type SerializableType => typeof(CharacterOptionsRequestPayload);
        public override PSOBBGamePacketPayloadClient Read(Span<byte> buffer, ref int offset)
        {
            CharacterOptionsRequestPayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(PSOBBGamePacketPayloadClient value, Span<byte> buffer, ref int offset)
        {
            CharacterOptionsRequestPayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// code for the Type: <see cref="CharacterOptionsRequestPayload"/>
    /// </summary>
    public sealed partial class CharacterOptionsRequestPayload_AutoGeneratedTemplateSerializerStrategy
        : BaseAutoGeneratedSerializerStrategy<CharacterOptionsRequestPayload_AutoGeneratedTemplateSerializerStrategy, CharacterOptionsRequestPayload>
    {
        /// <summary>
        ...
        public override void InternalRead(CharacterOptionsRequestPayload value, Span<byte> buffer, ref int offset)
        {
        ...
        /// <param name="buffer">See external doc.</param>
        /// <param name="offset">See external doc.</param>
        public override void InternalWrite(CharacterOptionsRequestPayload value, Span<byte> buffer, ref int offset)
        {
            //Type: PSOBBGamePacketPayloadClient Field: 1 Name: OperationCode Type: GameNetworkOperationCode;
