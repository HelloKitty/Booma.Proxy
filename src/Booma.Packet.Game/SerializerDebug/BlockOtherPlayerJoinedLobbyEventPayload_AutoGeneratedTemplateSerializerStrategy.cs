...
namespace Booma.Proxy
{
    ...
    public partial class BlockOtherPlayerJoinedLobbyEventPayload
    {
        ...
        {
            BlockOtherPlayerJoinedLobbyEventPayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(PSOBBGamePacketPayloadServer value, Span<byte> buffer, ref int offset)
        {
            BlockOtherPlayerJoinedLobbyEventPayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// </summary>
    public sealed partial class BlockOtherPlayerJoinedLobbyEventPayload_AutoGeneratedTemplateSerializerStrategy
            : BaseAutoGeneratedSerializerStrategy<BlockOtherPlayerJoinedLobbyEventPayload_AutoGeneratedTemplateSerializerStrategy, BlockOtherPlayerJoinedLobbyEventPayload>
    {
        /// <summary>
        ...
        public override void InternalRead(BlockOtherPlayerJoinedLobbyEventPayload value, Span<byte> buffer, ref int offset)
        {
            ...
            value.JoinData = CharacterJoinData_AutoGeneratedTemplateSerializerStrategy.Instance.Read(buffer, ref offset);
        }
        ...
        public override void InternalWrite(BlockOtherPlayerJoinedLobbyEventPayload value, Span<byte> buffer, ref int offset)
        {
            ...
            //Type: BlockOtherPlayerJoinedLobbyEventPayload Field: 8 Name: JoinData Type: CharacterJoinData;
            CharacterJoinData_AutoGeneratedTemplateSerializerStrategy.Instance.Write(value.JoinData, buffer, ref offset);
        }
