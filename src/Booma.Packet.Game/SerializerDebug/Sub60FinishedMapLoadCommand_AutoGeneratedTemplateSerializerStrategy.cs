...
namespace Booma.Proxy
{
    ...
    public partial class Sub60FinishedMapLoadCommand
    {
        ...
        {
            Sub60FinishedMapLoadCommand_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(BaseSubCommand60 value, Span<byte> buffer, ref int offset)
        {
            Sub60FinishedMapLoadCommand_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// </summary>
    public sealed partial class Sub60FinishedMapLoadCommand_AutoGeneratedTemplateSerializerStrategy
            : BaseAutoGeneratedSerializerStrategy<Sub60FinishedMapLoadCommand_AutoGeneratedTemplateSerializerStrategy, Sub60FinishedMapLoadCommand>
    {
        /// <summary>
