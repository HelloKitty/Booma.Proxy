...
namespace Booma.Proxy
{
    ...
    public partial class Sub60PlayerCastingTechniqueCommand
    {
        ...
        {
            Sub60PlayerCastingTechniqueCommand_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(BaseSubCommand60 value, Span<byte> buffer, ref int offset)
        {
            Sub60PlayerCastingTechniqueCommand_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// </summary>
    public sealed partial class Sub60PlayerCastingTechniqueCommand_AutoGeneratedTemplateSerializerStrategy
        : BaseAutoGeneratedSerializerStrategy<Sub60PlayerCastingTechniqueCommand_AutoGeneratedTemplateSerializerStrategy, Sub60PlayerCastingTechniqueCommand>
    {
        /// <summary>
        ...
        public override void InternalRead(Sub60PlayerCastingTechniqueCommand value, Span<byte> buffer, ref int offset)
        {
            ...
            value.Technique = TechniqueDefinitionData_AutoGeneratedTemplateSerializerStrategy.Instance.Read(buffer, ref offset);
            //Type: Sub60PlayerCastingTechniqueCommand Field: 5 Name: HitIdentifiers Type: TechniqueHitResult[];
            value.HitIdentifiers = SendSizeComplexArrayTypeSerializerStrategy<TechniqueHitResult_AutoGeneratedTemplateSerializerStrategy, TechniqueHitResult, Byte>.Instance.Read(buffer, ref offset);
        }
        ...
        public override void InternalWrite(Sub60PlayerCastingTechniqueCommand value, Span<byte> buffer, ref int offset)
        {
            ...
            //Type: Sub60PlayerCastingTechniqueCommand Field: 3 Name: Technique Type: TechniqueDefinitionData;
            TechniqueDefinitionData_AutoGeneratedTemplateSerializerStrategy.Instance.Write(value.Technique, buffer, ref offset);
            //Type: Sub60PlayerCastingTechniqueCommand Field: 5 Name: HitIdentifiers Type: TechniqueHitResult[];
            SendSizeComplexArrayTypeSerializerStrategy<TechniqueHitResult_AutoGeneratedTemplateSerializerStrategy, TechniqueHitResult, Byte>.Instance.Write(value.HitIdentifiers, buffer, ref offset);
        }
    }
}