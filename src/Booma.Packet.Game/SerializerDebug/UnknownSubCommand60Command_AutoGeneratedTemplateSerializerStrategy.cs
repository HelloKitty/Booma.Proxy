...
namespace Booma.Proxy
{
    ...
    public partial class UnknownSubCommand60Command
    {
        ...
        {
            UnknownSubCommand60Command_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(BaseSubCommand60 value, Span<byte> buffer, ref int offset)
        {
            UnknownSubCommand60Command_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// </summary>
    public sealed partial class UnknownSubCommand60Command_AutoGeneratedTemplateSerializerStrategy
        : BaseAutoGeneratedSerializerStrategy<UnknownSubCommand60Command_AutoGeneratedTemplateSerializerStrategy, UnknownSubCommand60Command>
    {
        /// <summary>
