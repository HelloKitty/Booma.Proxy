...
namespace Booma.Proxy
{
    ...
    public partial class SharedLoginResponsePayload
    {
        ...
        {
            SharedLoginResponsePayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(PSOBBGamePacketPayloadServer value, Span<byte> buffer, ref int offset)
        {
            SharedLoginResponsePayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// </summary>
    public sealed partial class SharedLoginResponsePayload_AutoGeneratedTemplateSerializerStrategy
            : BaseAutoGeneratedSerializerStrategy<SharedLoginResponsePayload_AutoGeneratedTemplateSerializerStrategy, SharedLoginResponsePayload>
    {
        /// <summary>
