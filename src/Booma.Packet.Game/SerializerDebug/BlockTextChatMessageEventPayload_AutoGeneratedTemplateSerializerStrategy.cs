...
namespace Booma.Proxy
{
    ...
    public partial class BlockTextChatMessageEventPayload
    {
        ...
        {
            BlockTextChatMessageEventPayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(PSOBBGamePacketPayloadServer value, Span<byte> buffer, ref int offset)
        {
            BlockTextChatMessageEventPayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// </summary>
    public sealed partial class BlockTextChatMessageEventPayload_AutoGeneratedTemplateSerializerStrategy
        : BaseAutoGeneratedSerializerStrategy<BlockTextChatMessageEventPayload_AutoGeneratedTemplateSerializerStrategy, BlockTextChatMessageEventPayload>
    {
        /// <summary>
