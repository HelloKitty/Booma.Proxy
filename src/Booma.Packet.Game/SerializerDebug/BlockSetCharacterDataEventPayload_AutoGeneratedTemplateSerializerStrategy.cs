...
namespace Booma.Proxy
{
    ...
    public partial class BlockSetCharacterDataEventPayload
    {
        public override Type SerializableType => typeof(BlockSetCharacterDataEventPayload);
        public override PSOBBGamePacketPayloadServer Read(Span<byte> buffer, ref int offset)
        {
            BlockSetCharacterDataEventPayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(PSOBBGamePacketPayloadServer value, Span<byte> buffer, ref int offset)
        {
            BlockSetCharacterDataEventPayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// code for the Type: <see cref="BlockSetCharacterDataEventPayload"/>
    /// </summary>
    public sealed partial class BlockSetCharacterDataEventPayload_AutoGeneratedTemplateSerializerStrategy
            : BaseAutoGeneratedSerializerStrategy<BlockSetCharacterDataEventPayload_AutoGeneratedTemplateSerializerStrategy, BlockSetCharacterDataEventPayload>
    {
        /// <summary>
        ...
        public override void InternalRead(BlockSetCharacterDataEventPayload value, Span<byte> buffer, ref int offset)
        {
        ...
        /// <param name="buffer">See external doc.</param>
        /// <param name="offset">See external doc.</param>
        public override void InternalWrite(BlockSetCharacterDataEventPayload value, Span<byte> buffer, ref int offset)
        {
            //Type: PSOBBGamePacketPayloadServer Field: 1 Name: OperationCode Type: GameNetworkOperationCode;
