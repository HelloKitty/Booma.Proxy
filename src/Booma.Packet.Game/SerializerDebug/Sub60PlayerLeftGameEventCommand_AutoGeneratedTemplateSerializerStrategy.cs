...
namespace Booma.Proxy
{
    ...
    public partial class Sub60PlayerLeftGameEventCommand
    {
        ...
        {
            Sub60PlayerLeftGameEventCommand_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(BaseSubCommand60 value, Span<byte> buffer, ref int offset)
        {
            Sub60PlayerLeftGameEventCommand_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// </summary>
    public sealed partial class Sub60PlayerLeftGameEventCommand_AutoGeneratedTemplateSerializerStrategy
            : BaseAutoGeneratedSerializerStrategy<Sub60PlayerLeftGameEventCommand_AutoGeneratedTemplateSerializerStrategy, Sub60PlayerLeftGameEventCommand>
    {
        /// <summary>
