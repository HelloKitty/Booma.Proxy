...
namespace Booma.Proxy
{
    ...
    public partial class BlockCharacterDataInitializeClientResponsePayload
    {
        public override Type SerializableType => typeof(BlockCharacterDataInitializeClientResponsePayload);
        public override PSOBBGamePacketPayloadClient Read(Span<byte> buffer, ref int offset)
        {
            BlockCharacterDataInitializeClientResponsePayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(PSOBBGamePacketPayloadClient value, Span<byte> buffer, ref int offset)
        {
            BlockCharacterDataInitializeClientResponsePayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// code for the Type: <see cref="BlockCharacterDataInitializeClientResponsePayload"/>
    /// </summary>
    public sealed partial class BlockCharacterDataInitializeClientResponsePayload_AutoGeneratedTemplateSerializerStrategy
            : BaseAutoGeneratedSerializerStrategy<BlockCharacterDataInitializeClientResponsePayload_AutoGeneratedTemplateSerializerStrategy, BlockCharacterDataInitializeClientResponsePayload>
    {
        /// <summary>
        ...
        public override void InternalRead(BlockCharacterDataInitializeClientResponsePayload value, Span<byte> buffer, ref int offset)
        {
            ...
            //Type: BlockCharacterDataInitializeClientResponsePayload Field: 1 Name: Bytes Type: Byte[];
        ...
        /// <param name="buffer">See external doc.</param>
        /// <param name="offset">See external doc.</param>
        public override void InternalWrite(BlockCharacterDataInitializeClientResponsePayload value, Span<byte> buffer, ref int offset)
        {
            //Type: PSOBBGamePacketPayloadClient Field: 1 Name: OperationCode Type: GameNetworkOperationCode;
