...
namespace Booma.Proxy
{
    ...
    public partial class Sub60PlayerFinishedAttackStepEvent
    {
        ...
        {
            Sub60PlayerFinishedAttackStepEvent_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(BaseSubCommand60 value, Span<byte> buffer, ref int offset)
        {
            Sub60PlayerFinishedAttackStepEvent_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// </summary>
    public sealed partial class Sub60PlayerFinishedAttackStepEvent_AutoGeneratedTemplateSerializerStrategy
            : BaseAutoGeneratedSerializerStrategy<Sub60PlayerFinishedAttackStepEvent_AutoGeneratedTemplateSerializerStrategy, Sub60PlayerFinishedAttackStepEvent>
    {
        /// <summary>
        ...
        public override void InternalRead(Sub60PlayerFinishedAttackStepEvent value, Span<byte> buffer, ref int offset)
        {
            ...
            value._HitResults = SendSizeComplexArrayTypeSerializerStrategy<AttackHitResult_AutoGeneratedTemplateSerializerStrategy, AttackHitResult, UInt16>.Instance.Read(buffer, ref offset);
        ...
        public override void InternalWrite(Sub60PlayerFinishedAttackStepEvent value, Span<byte> buffer, ref int offset)
        {
            ...
            //Type: Sub60PlayerFinishedAttackStepEvent Field: 3 Name: _HitResults Type: AttackHitResult[];
            SendSizeComplexArrayTypeSerializerStrategy<AttackHitResult_AutoGeneratedTemplateSerializerStrategy, AttackHitResult, UInt16>.Instance.Write(value._HitResults, buffer, ref offset);
            //Type: Sub60PlayerFinishedAttackStepEvent Field: 4 Name: unk2 Type: Int16;
