...
namespace Booma.Proxy
{
    ...
    public partial class BlockFinishedGameBurstingRequestPayload
    {
        public override Type SerializableType => typeof(BlockFinishedGameBurstingRequestPayload);
        public override PSOBBGamePacketPayloadClient Read(Span<byte> buffer, ref int offset)
        {
            BlockFinishedGameBurstingRequestPayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(PSOBBGamePacketPayloadClient value, Span<byte> buffer, ref int offset)
        {
            BlockFinishedGameBurstingRequestPayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// code for the Type: <see cref="BlockFinishedGameBurstingRequestPayload"/>
    /// </summary>
    public sealed partial class BlockFinishedGameBurstingRequestPayload_AutoGeneratedTemplateSerializerStrategy
        : BaseAutoGeneratedSerializerStrategy<BlockFinishedGameBurstingRequestPayload_AutoGeneratedTemplateSerializerStrategy, BlockFinishedGameBurstingRequestPayload>
    {
        /// <summary>
        ...
        public override void InternalRead(BlockFinishedGameBurstingRequestPayload value, Span<byte> buffer, ref int offset)
        {
        ...
        /// <param name="buffer">See external doc.</param>
        /// <param name="offset">See external doc.</param>
        public override void InternalWrite(BlockFinishedGameBurstingRequestPayload value, Span<byte> buffer, ref int offset)
        {
            //Type: PSOBBGamePacketPayloadClient Field: 1 Name: OperationCode Type: GameNetworkOperationCode;
