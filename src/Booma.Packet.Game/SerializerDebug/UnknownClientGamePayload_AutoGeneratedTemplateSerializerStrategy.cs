...
namespace Booma.Proxy
{
    ...
    public partial class UnknownClientGamePayload
    {
        public override Type SerializableType => typeof(UnknownClientGamePayload);
        public override PSOBBGamePacketPayloadClient Read(Span<byte> buffer, ref int offset)
        {
            UnknownClientGamePayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(PSOBBGamePacketPayloadClient value, Span<byte> buffer, ref int offset)
        {
            UnknownClientGamePayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// code for the Type: <see cref="UnknownClientGamePayload"/>
    /// </summary>
    public sealed partial class UnknownClientGamePayload_AutoGeneratedTemplateSerializerStrategy
        : BaseAutoGeneratedSerializerStrategy<UnknownClientGamePayload_AutoGeneratedTemplateSerializerStrategy, UnknownClientGamePayload>
    {
        /// <summary>
        ...
        public override void InternalRead(UnknownClientGamePayload value, Span<byte> buffer, ref int offset)
        {
            ...
            //Type: UnknownClientGamePayload Field: 1 Name: UnknownBytes Type: Byte[];
        ...
        /// <param name="buffer">See external doc.</param>
        /// <param name="offset">See external doc.</param>
        public override void InternalWrite(UnknownClientGamePayload value, Span<byte> buffer, ref int offset)
        {
            //Type: PSOBBGamePacketPayloadClient Field: 1 Name: OperationCode Type: GameNetworkOperationCode;
