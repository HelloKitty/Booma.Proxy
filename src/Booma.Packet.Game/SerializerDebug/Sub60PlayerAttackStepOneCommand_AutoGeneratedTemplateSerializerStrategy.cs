...
namespace Booma.Proxy
{
    ...
    public partial class Sub60PlayerAttackStepOneCommand
    {
        ...
        {
            Sub60PlayerAttackStepOneCommand_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(BaseSubCommand60 value, Span<byte> buffer, ref int offset)
        {
            Sub60PlayerAttackStepOneCommand_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// </summary>
    public sealed partial class Sub60PlayerAttackStepOneCommand_AutoGeneratedTemplateSerializerStrategy
        : BaseAutoGeneratedSerializerStrategy<Sub60PlayerAttackStepOneCommand_AutoGeneratedTemplateSerializerStrategy, Sub60PlayerAttackStepOneCommand>
    {
        /// <summary>
