...
namespace FreecraftCore.Serializer
{
	...
	/// </summary>
	public sealed partial class DataParameterFileHeader_Serializer : BaseAutoGeneratedSerializerStrategy<DataParameterFileHeader_Serializer, DataParameterFileHeader>
	{
		/// <summary>
