...
namespace Booma
{
	...
	public partial class CharacterOptionsRequestPayload
	{
		...
		{
			CharacterOptionsRequestPayload_Serializer.Instance.InternalRead(this, buffer, ref offset);
			return this;
		}

		public override void Write(PSOBBGamePacketPayloadClient value, Span<byte> buffer, ref int offset)
		{
			CharacterOptionsRequestPayload_Serializer.Instance.InternalWrite(this, buffer, ref offset);
		}
	}
}
...
namespace FreecraftCore.Serializer
{
	...
	/// </summary>
	public sealed partial class CharacterOptionsRequestPayload_Serializer : BaseAutoGeneratedSerializerStrategy<CharacterOptionsRequestPayload_Serializer, CharacterOptionsRequestPayload>
	{
		/// <summary>
