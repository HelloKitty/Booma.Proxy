...
namespace Booma
{
	...
	public partial class BlockCharacterDataInitializationServerRequestPayload
	{
		...
		{
			BlockCharacterDataInitializationServerRequestPayload_Serializer.Instance.InternalRead(this, buffer, ref offset);
			return this;
		}

		public override void Write(PSOBBGamePacketPayloadServer value, Span<byte> buffer, ref int offset)
		{
			BlockCharacterDataInitializationServerRequestPayload_Serializer.Instance.InternalWrite(this, buffer, ref offset);
		}
	}
}
...
namespace FreecraftCore.Serializer
{
	...
	/// </summary>
	public sealed partial class BlockCharacterDataInitializationServerRequestPayload_Serializer : BaseAutoGeneratedSerializerStrategy<BlockCharacterDataInitializationServerRequestPayload_Serializer, BlockCharacterDataInitializationServerRequestPayload>
	{
		/// <summary>
