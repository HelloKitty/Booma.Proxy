...
namespace Booma
{
	...
	public partial class CharacterChecksumRequestPayload
	{
		...
		{
			CharacterChecksumRequestPayload_Serializer.Instance.InternalRead(this, buffer, ref offset);
			return this;
		}

		public override void Write(PSOBBGamePacketPayloadClient value, Span<byte> buffer, ref int offset)
		{
			CharacterChecksumRequestPayload_Serializer.Instance.InternalWrite(this, buffer, ref offset);
		}
	}
}
...
namespace FreecraftCore.Serializer
{
	...
	/// </summary>
	public sealed partial class CharacterChecksumRequestPayload_Serializer : BaseAutoGeneratedSerializerStrategy<CharacterChecksumRequestPayload_Serializer, CharacterChecksumRequestPayload>
	{
		/// <summary>
