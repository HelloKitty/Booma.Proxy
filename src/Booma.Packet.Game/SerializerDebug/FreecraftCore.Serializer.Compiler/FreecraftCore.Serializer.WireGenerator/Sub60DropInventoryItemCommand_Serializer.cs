...
namespace Booma
{
	...
	public partial class Sub60DropInventoryItemCommand
	{
		...
		{
			Sub60DropInventoryItemCommand_Serializer.Instance.InternalRead(this, buffer, ref offset);
			return this;
		}

		public override void Write(BaseSubCommand60 value, Span<byte> buffer, ref int offset)
		{
			Sub60DropInventoryItemCommand_Serializer.Instance.InternalWrite(this, buffer, ref offset);
		}
	}
}
...
namespace FreecraftCore.Serializer
{
	...
	/// </summary>
	public sealed partial class Sub60DropInventoryItemCommand_Serializer : BaseAutoGeneratedSerializerStrategy<Sub60DropInventoryItemCommand_Serializer, Sub60DropInventoryItemCommand>
	{
		/// <summary>
