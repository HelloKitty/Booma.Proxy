...
namespace Booma
{
	...
	public partial class BaseSubCommand60 : IWireMessage<BaseSubCommand60>
	{
		...
		{
			BaseSubCommand60_Serializer.Instance.InternalRead(this, buffer, ref offset);
			return this;
		}

		public virtual void Write(BaseSubCommand60 value, Span<byte> buffer, ref int offset)
		{
			BaseSubCommand60_Serializer.Instance.InternalWrite(this, buffer, ref offset);
		}
	}
}
...
namespace FreecraftCore.Serializer
{
	...
	/// </summary>
	public sealed partial class BaseSubCommand60_Serializer : BasePolymorphicAutoGeneratedSerializerStrategy<BaseSubCommand60_Serializer, BaseSubCommand60, Byte>
	{
		protected override BaseSubCommand60 CreateType(int key)
		{
			switch (key)
			{
				case (int)Booma.SubCommand60OperationCode.GameBoxHit:
					return new Sub60ClientBoxHitEventCommand();
				case (int)Booma.SubCommand60OperationCode.BurstType5:
				...
				case (int)Booma.SubCommand60OperationCode.SUBCMD_LOAD_3B:
					return new Sub60FinishedMapLoadCommand();
				case (int)Booma.SubCommand60OperationCode.SetFinalMovingPosition:
					return new Sub60FinishedMovingCommand();
				case (int)Booma.SubCommand60OperationCode.AlertFreshlyWarpedClients:
					return new Sub60FinishedWarpAckCommand();
				case (int)Booma.SubCommand60OperationCode.EnterFreshlyWrappedZoneCommand:
					return new Sub60FinishedWarpingBurstingCommand();
				case (int)Booma.SubCommand60OperationCode.GameBurstingComplete:
					return new Sub60GameBurstingCompleteEventCommand();
				case (int)Booma.SubCommand60OperationCode.LobbyBallMove:
					return new Sub60LobbySoccerBallMoveEventPayload();
				case (int)Booma.SubCommand60OperationCode.MovingFastPositionChanged:
					return new Sub60MovingFastPositionSetCommand();
				case (int)Booma.SubCommand60OperationCode.MovingSlowPositionChanged:
					return new Sub60MovingSlowPositionSetCommand();
				case (int)Booma.SubCommand60OperationCode.ObjectDamageHit:
					return new Sub60ObjectDamageRecievedCommand();
				case (int)Booma.SubCommand60OperationCode.PickupItem:
					return new Sub60PickupItemFromGroundCommand();
				case (int)Booma.SubCommand60OperationCode.AttackStepOne:
					return new Sub60PlayerAttackStepOneCommand();
				case (int)Booma.SubCommand60OperationCode.BeginTechniqueCast:
					return new Sub60PlayerBeginTechniqueCastCommand();
				case (int)Booma.SubCommand60OperationCode.CastingTechiqueCast:
					return new Sub60PlayerCastingTechniqueCommand();
				case (int)Booma.SubCommand60OperationCode.ChangeObjectState:
					return new Sub60PlayerChangedObjectStateCommand();
				case (int)Booma.SubCommand60OperationCode.AttackStepFinished:
					return new Sub60PlayerFinishedAttackStepEvent();
				case (int)Booma.SubCommand60OperationCode.FreezePlayer:
					return new Sub60PlayerFreezeCommand();
				case (int)Booma.SubCommand60OperationCode.BeginObjectInteract:
					return new Sub60PlayerInteractObjectCommand();
				case (int)Booma.SubCommand60OperationCode.GAME_LEAVE_TYPE:
					return new Sub60PlayerLeftGameEventCommand();
				case (int)Booma.SubCommand60OperationCode.PhotonChairSit:
					return new Sub60PlayerPhotonChairSitEventCommand();
				case (int)Booma.SubCommand60OperationCode.FinishedTechniqueCast:
					return new Sub60PlayFinishedTechniqueCastCommand();
				case (int)Booma.SubCommand60OperationCode.SetExperienceRate:
					return new Sub60SetExperienceRateCommand();
				case (int)Booma.SubCommand60OperationCode.GameStartWarpToArea:
					return new Sub60StartNewWarpCommand();
				case (int)Booma.SubCommand60OperationCode.TeleportToPosition:
					return new Sub60TeleportToPositionCommand();
				case (int)Booma.SubCommand60OperationCode.WrapToNewArea:
