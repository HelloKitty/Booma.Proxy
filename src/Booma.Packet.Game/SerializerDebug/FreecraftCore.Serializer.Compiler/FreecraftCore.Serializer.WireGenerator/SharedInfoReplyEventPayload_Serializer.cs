...
namespace Booma
{
	...
	public partial class SharedInfoReplyEventPayload
	{
		...
		{
			SharedInfoReplyEventPayload_Serializer.Instance.InternalRead(this, buffer, ref offset);
			return this;
		}

		public override void Write(PSOBBGamePacketPayloadServer value, Span<byte> buffer, ref int offset)
		{
			SharedInfoReplyEventPayload_Serializer.Instance.InternalWrite(this, buffer, ref offset);
		}
	}
}
...
namespace FreecraftCore.Serializer
{
	...
	/// </summary>
	public sealed partial class SharedInfoReplyEventPayload_Serializer : BaseAutoGeneratedSerializerStrategy<SharedInfoReplyEventPayload_Serializer, SharedInfoReplyEventPayload>
	{
		/// <summary>
