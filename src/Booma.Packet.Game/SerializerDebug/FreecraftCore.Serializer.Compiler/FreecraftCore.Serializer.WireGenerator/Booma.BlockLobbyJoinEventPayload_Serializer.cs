...
namespace Booma
{
    ...
    public partial class BlockLobbyJoinEventPayload
    {
        ...
        {
            Booma.BlockLobbyJoinEventPayload_Serializer.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(PSOBBGamePacketPayloadServer value, Span<byte> buffer, ref int offset)
        {
            Booma.BlockLobbyJoinEventPayload_Serializer.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}