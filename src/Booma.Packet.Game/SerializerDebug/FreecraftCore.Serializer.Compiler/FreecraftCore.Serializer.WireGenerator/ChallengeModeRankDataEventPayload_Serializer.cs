...
namespace Booma
{
	...
	public partial class ChallengeModeRankDataEventPayload
	{
		public override Type SerializableType => typeof(ChallengeModeRankDataEventPayload);
		public override PSOBBGamePacketPayloadServer Read(Span<byte> buffer, ref int offset)
		{
			ChallengeModeRankDataEventPayload_Serializer.Instance.InternalRead(this, buffer, ref offset);
			return this;
		}

		public override void Write(PSOBBGamePacketPayloadServer value, Span<byte> buffer, ref int offset)
		{
			ChallengeModeRankDataEventPayload_Serializer.Instance.InternalWrite(this, buffer, ref offset);
		}
	}
}
...
namespace FreecraftCore.Serializer
{
	...
	/// code for the Type: <see cref = "ChallengeModeRankDataEventPayload"/>
	/// </summary>
	public sealed partial class ChallengeModeRankDataEventPayload_Serializer : BaseAutoGeneratedSerializerStrategy<ChallengeModeRankDataEventPayload_Serializer, ChallengeModeRankDataEventPayload>
	{
		/// <summary>
		...
		public override void InternalRead(ChallengeModeRankDataEventPayload value, Span<byte> buffer, ref int offset)
		{
		...
		/// <param name = "buffer">See external doc.</param>
		/// <param name = "offset">See external doc.</param>
		public override void InternalWrite(ChallengeModeRankDataEventPayload value, Span<byte> buffer, ref int offset)
		{
			//Type: PSOBBGamePacketPayloadServer Field: 1 Name: OperationCode Type: GameNetworkOperationCode
			;
