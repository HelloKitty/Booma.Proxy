...
namespace Booma
{
	...
	public partial class LobbyListEventPayload
	{
		public override Type SerializableType => typeof(LobbyListEventPayload);
		public override PSOBBGamePacketPayloadServer Read(Span<byte> buffer, ref int offset)
		{
			LobbyListEventPayload_Serializer.Instance.InternalRead(this, buffer, ref offset);
			return this;
		}

		public override void Write(PSOBBGamePacketPayloadServer value, Span<byte> buffer, ref int offset)
		{
			LobbyListEventPayload_Serializer.Instance.InternalWrite(this, buffer, ref offset);
		}
	}
}
...
namespace FreecraftCore.Serializer
{
	...
	/// code for the Type: <see cref = "LobbyListEventPayload"/>
	/// </summary>
	public sealed partial class LobbyListEventPayload_Serializer : BaseAutoGeneratedSerializerStrategy<LobbyListEventPayload_Serializer, LobbyListEventPayload>
	{
		/// <summary>
		...
		public override void InternalRead(LobbyListEventPayload value, Span<byte> buffer, ref int offset)
		{
			...
			//Type: LobbyListEventPayload Field: 1 Name: _Lobbies Type: LobbyMenuEntry[]
			;
			value._Lobbies = SendSizeComplexArrayTypeSerializerStrategy<LobbyMenuEntry_Serializer, LobbyMenuEntry, Int32>.Instance.Read(buffer, ref offset);
			//Type: LobbyListEventPayload Field: 2 Name: Padding Type: Byte[]
			;
		...
		/// <param name = "buffer">See external doc.</param>
		/// <param name = "offset">See external doc.</param>
		public override void InternalWrite(LobbyListEventPayload value, Span<byte> buffer, ref int offset)
		{
			//Type: PSOBBGamePacketPayloadServer Field: 1 Name: OperationCode Type: GameNetworkOperationCode
			;
			...
			//Type: LobbyListEventPayload Field: 1 Name: _Lobbies Type: LobbyMenuEntry[]
			;
			SendSizeComplexArrayTypeSerializerStrategy<LobbyMenuEntry_Serializer, LobbyMenuEntry, Int32>.Instance.Write(value._Lobbies, buffer, ref offset);
			//Type: LobbyListEventPayload Field: 2 Name: Padding Type: Byte[]
			;
