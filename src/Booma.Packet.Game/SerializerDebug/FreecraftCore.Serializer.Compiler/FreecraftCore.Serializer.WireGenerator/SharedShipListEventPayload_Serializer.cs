...
namespace FreecraftCore.Serializer
{
	...
	/// </summary>
	public sealed partial class SharedShipListEventPayload_Serializer : BaseAutoGeneratedSerializerStrategy<SharedShipListEventPayload_Serializer, SharedShipListEventPayload>
	{
		/// <summary>
