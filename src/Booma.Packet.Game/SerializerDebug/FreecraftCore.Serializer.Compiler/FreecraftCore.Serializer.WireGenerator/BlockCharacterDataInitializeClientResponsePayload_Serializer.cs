...
namespace Booma
{
	...
	public partial class BlockCharacterDataInitializeClientResponsePayload
	{
		...
		{
			BlockCharacterDataInitializeClientResponsePayload_Serializer.Instance.InternalRead(this, buffer, ref offset);
			return this;
		}

		public override void Write(PSOBBGamePacketPayloadClient value, Span<byte> buffer, ref int offset)
		{
			BlockCharacterDataInitializeClientResponsePayload_Serializer.Instance.InternalWrite(this, buffer, ref offset);
		}
	}
}
...
namespace FreecraftCore.Serializer
{
	...
	/// </summary>
	public sealed partial class BlockCharacterDataInitializeClientResponsePayload_Serializer : BaseAutoGeneratedSerializerStrategy<BlockCharacterDataInitializeClientResponsePayload_Serializer, BlockCharacterDataInitializeClientResponsePayload>
	{
		/// <summary>
		...
		private sealed class StaticTypedNumeric_Int32_2088 : StaticTypedNumeric<Int32>
		{
			public sealed override Int32 Value => 2088;
		}
