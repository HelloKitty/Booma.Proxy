...
namespace Booma
{
	...
	public partial class CharacterDataParametersHeaderRequestPayload
	{
		...
		{
			CharacterDataParametersHeaderRequestPayload_Serializer.Instance.InternalRead(this, buffer, ref offset);
			return this;
		}

		public override void Write(PSOBBGamePacketPayloadClient value, Span<byte> buffer, ref int offset)
		{
			CharacterDataParametersHeaderRequestPayload_Serializer.Instance.InternalWrite(this, buffer, ref offset);
		}
	}
}
...
namespace FreecraftCore.Serializer
{
	...
	/// </summary>
	public sealed partial class CharacterDataParametersHeaderRequestPayload_Serializer : BaseAutoGeneratedSerializerStrategy<CharacterDataParametersHeaderRequestPayload_Serializer, CharacterDataParametersHeaderRequestPayload>
	{
		/// <summary>
