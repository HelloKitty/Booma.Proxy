...
namespace Booma
{
	...
	public partial class Sub60FinishedMovingCommand
	{
		...
		{
			Sub60FinishedMovingCommand_Serializer.Instance.InternalRead(this, buffer, ref offset);
			return this;
		}

		public override void Write(BaseSubCommand60 value, Span<byte> buffer, ref int offset)
		{
			Sub60FinishedMovingCommand_Serializer.Instance.InternalWrite(this, buffer, ref offset);
		}
	}
}
...
namespace FreecraftCore.Serializer
{
	...
	/// </summary>
	public sealed partial class Sub60FinishedMovingCommand_Serializer : BaseAutoGeneratedSerializerStrategy<Sub60FinishedMovingCommand_Serializer, Sub60FinishedMovingCommand>
	{
		/// <summary>
