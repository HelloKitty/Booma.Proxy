...
namespace Booma
{
	...
	public partial class Sub60ClientBurstBeginEventCommand
	{
		...
		{
			Sub60ClientBurstBeginEventCommand_Serializer.Instance.InternalRead(this, buffer, ref offset);
			return this;
		}

		public override void Write(BaseSubCommand60 value, Span<byte> buffer, ref int offset)
		{
			Sub60ClientBurstBeginEventCommand_Serializer.Instance.InternalWrite(this, buffer, ref offset);
		}
	}
}
...
namespace FreecraftCore.Serializer
{
	...
	/// </summary>
	public sealed partial class Sub60ClientBurstBeginEventCommand_Serializer : BaseAutoGeneratedSerializerStrategy<Sub60ClientBurstBeginEventCommand_Serializer, Sub60ClientBurstBeginEventCommand>
	{
		/// <summary>
