...
namespace Booma
{
	...
	public partial class BlockOtherPlayerLeaveLobbyEventPayload
	{
		...
		{
			BlockOtherPlayerLeaveLobbyEventPayload_Serializer.Instance.InternalRead(this, buffer, ref offset);
			return this;
		}

		public override void Write(PSOBBGamePacketPayloadServer value, Span<byte> buffer, ref int offset)
		{
			BlockOtherPlayerLeaveLobbyEventPayload_Serializer.Instance.InternalWrite(this, buffer, ref offset);
		}
	}
}
...
namespace FreecraftCore.Serializer
{
	...
	/// </summary>
	public sealed partial class BlockOtherPlayerLeaveLobbyEventPayload_Serializer : BaseAutoGeneratedSerializerStrategy<BlockOtherPlayerLeaveLobbyEventPayload_Serializer, BlockOtherPlayerLeaveLobbyEventPayload>
	{
		/// <summary>
