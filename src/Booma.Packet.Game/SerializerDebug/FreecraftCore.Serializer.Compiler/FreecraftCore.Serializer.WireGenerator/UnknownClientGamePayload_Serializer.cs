...
namespace Booma
{
	...
	public partial class UnknownClientGamePayload
	{
		...
		{
			UnknownClientGamePayload_Serializer.Instance.InternalRead(this, buffer, ref offset);
			return this;
		}

		public override void Write(PSOBBGamePacketPayloadClient value, Span<byte> buffer, ref int offset)
		{
			UnknownClientGamePayload_Serializer.Instance.InternalWrite(this, buffer, ref offset);
		}
	}
}
...
namespace FreecraftCore.Serializer
{
	...
	/// </summary>
	public sealed partial class UnknownClientGamePayload_Serializer : BaseAutoGeneratedSerializerStrategy<UnknownClientGamePayload_Serializer, UnknownClientGamePayload>
	{
		/// <summary>
