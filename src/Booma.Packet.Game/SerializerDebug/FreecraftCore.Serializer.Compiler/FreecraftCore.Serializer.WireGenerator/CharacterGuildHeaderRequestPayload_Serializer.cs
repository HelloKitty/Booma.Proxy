...
namespace Booma
{
	...
	public partial class CharacterGuildHeaderRequestPayload
	{
		...
		{
			CharacterGuildHeaderRequestPayload_Serializer.Instance.InternalRead(this, buffer, ref offset);
			return this;
		}

		public override void Write(PSOBBGamePacketPayloadClient value, Span<byte> buffer, ref int offset)
		{
			CharacterGuildHeaderRequestPayload_Serializer.Instance.InternalWrite(this, buffer, ref offset);
		}
	}
}
...
namespace FreecraftCore.Serializer
{
	...
	/// </summary>
	public sealed partial class CharacterGuildHeaderRequestPayload_Serializer : BaseAutoGeneratedSerializerStrategy<CharacterGuildHeaderRequestPayload_Serializer, CharacterGuildHeaderRequestPayload>
	{
		/// <summary>
