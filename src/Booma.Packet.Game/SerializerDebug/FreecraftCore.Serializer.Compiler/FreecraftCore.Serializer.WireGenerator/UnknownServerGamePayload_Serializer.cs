...
namespace Booma
{
	...
	public partial class UnknownServerGamePayload
	{
		...
		{
			UnknownServerGamePayload_Serializer.Instance.InternalRead(this, buffer, ref offset);
			return this;
		}

		public override void Write(PSOBBGamePacketPayloadServer value, Span<byte> buffer, ref int offset)
		{
			UnknownServerGamePayload_Serializer.Instance.InternalWrite(this, buffer, ref offset);
		}
	}
}
...
namespace FreecraftCore.Serializer
{
	...
	/// </summary>
	public sealed partial class UnknownServerGamePayload_Serializer : BaseAutoGeneratedSerializerStrategy<UnknownServerGamePayload_Serializer, UnknownServerGamePayload>
	{
		/// <summary>
