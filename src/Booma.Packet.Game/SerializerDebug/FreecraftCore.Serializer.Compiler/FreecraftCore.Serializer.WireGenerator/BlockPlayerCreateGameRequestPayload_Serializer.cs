...
namespace Booma
{
	...
	public partial class BlockPlayerCreateGameRequestPayload
	{
		...
		{
			BlockPlayerCreateGameRequestPayload_Serializer.Instance.InternalRead(this, buffer, ref offset);
			return this;
		}

		public override void Write(PSOBBGamePacketPayloadClient value, Span<byte> buffer, ref int offset)
		{
			BlockPlayerCreateGameRequestPayload_Serializer.Instance.InternalWrite(this, buffer, ref offset);
		}
	}
}
...
namespace FreecraftCore.Serializer
{
	...
	/// </summary>
	public sealed partial class BlockPlayerCreateGameRequestPayload_Serializer : BaseAutoGeneratedSerializerStrategy<BlockPlayerCreateGameRequestPayload_Serializer, BlockPlayerCreateGameRequestPayload>
	{
		/// <summary>
