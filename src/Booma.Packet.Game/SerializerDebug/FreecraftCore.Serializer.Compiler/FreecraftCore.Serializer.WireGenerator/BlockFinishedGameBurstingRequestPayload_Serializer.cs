...
namespace Booma
{
	...
	public partial class BlockFinishedGameBurstingRequestPayload
	{
		...
		{
			BlockFinishedGameBurstingRequestPayload_Serializer.Instance.InternalRead(this, buffer, ref offset);
			return this;
		}

		public override void Write(PSOBBGamePacketPayloadClient value, Span<byte> buffer, ref int offset)
		{
			BlockFinishedGameBurstingRequestPayload_Serializer.Instance.InternalWrite(this, buffer, ref offset);
		}
	}
}
...
namespace FreecraftCore.Serializer
{
	...
	/// </summary>
	public sealed partial class BlockFinishedGameBurstingRequestPayload_Serializer : BaseAutoGeneratedSerializerStrategy<BlockFinishedGameBurstingRequestPayload_Serializer, BlockFinishedGameBurstingRequestPayload>
	{
		/// <summary>
