...
namespace FreecraftCore.Serializer
{
	...
	/// </summary>
	public sealed partial class BaseSubCommand62_Serializer : BasePolymorphicAutoGeneratedSerializerStrategy<BaseSubCommand62_Serializer, BaseSubCommand62, Byte>
	{
		protected override BaseSubCommand62 CreateType(int key)
		{
			switch (key)
			{
				case (int)Booma.SubCommand62OperationCode.BurstType5:
					return new Sub62ClientBurstBeginEventCommand();
				case (int)Booma.SubCommand62OperationCode.PhotonChairCommand:
