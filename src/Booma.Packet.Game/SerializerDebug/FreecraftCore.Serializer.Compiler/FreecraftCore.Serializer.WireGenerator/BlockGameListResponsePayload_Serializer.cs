...
namespace Booma
{
	...
	public partial class BlockGameListResponsePayload
	{
		...
		{
			BlockGameListResponsePayload_Serializer.Instance.InternalRead(this, buffer, ref offset);
			return this;
		}

		public override void Write(PSOBBGamePacketPayloadServer value, Span<byte> buffer, ref int offset)
		{
			BlockGameListResponsePayload_Serializer.Instance.InternalWrite(this, buffer, ref offset);
		}
	}
}
...
namespace FreecraftCore.Serializer
{
	...
	/// </summary>
	public sealed partial class BlockGameListResponsePayload_Serializer : BaseAutoGeneratedSerializerStrategy<BlockGameListResponsePayload_Serializer, BlockGameListResponsePayload>
	{
		/// <summary>
