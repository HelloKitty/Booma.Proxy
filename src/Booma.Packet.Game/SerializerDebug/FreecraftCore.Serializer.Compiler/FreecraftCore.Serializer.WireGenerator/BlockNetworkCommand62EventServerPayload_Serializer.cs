...
namespace Booma
{
	...
	public partial class BlockNetworkCommand62EventServerPayload
	{
		...
		{
			BlockNetworkCommand62EventServerPayload_Serializer.Instance.InternalRead(this, buffer, ref offset);
			return this;
		}

		public override void Write(PSOBBGamePacketPayloadServer value, Span<byte> buffer, ref int offset)
		{
			BlockNetworkCommand62EventServerPayload_Serializer.Instance.InternalWrite(this, buffer, ref offset);
		}
	}
}
...
namespace FreecraftCore.Serializer
{
	...
	/// </summary>
	public sealed partial class BlockNetworkCommand62EventServerPayload_Serializer : BaseAutoGeneratedSerializerStrategy<BlockNetworkCommand62EventServerPayload_Serializer, BlockNetworkCommand62EventServerPayload>
	{
		/// <summary>
