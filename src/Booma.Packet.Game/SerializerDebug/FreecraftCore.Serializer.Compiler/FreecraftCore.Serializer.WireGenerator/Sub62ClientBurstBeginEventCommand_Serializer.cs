...
namespace Booma
{
	...
	public partial class Sub62ClientBurstBeginEventCommand
	{
		...
		{
			Sub62ClientBurstBeginEventCommand_Serializer.Instance.InternalRead(this, buffer, ref offset);
			return this;
		}

		public override void Write(BaseSubCommand62 value, Span<byte> buffer, ref int offset)
		{
			Sub62ClientBurstBeginEventCommand_Serializer.Instance.InternalWrite(this, buffer, ref offset);
		}
	}
}
...
namespace FreecraftCore.Serializer
{
	...
	/// </summary>
	public sealed partial class Sub62ClientBurstBeginEventCommand_Serializer : BaseAutoGeneratedSerializerStrategy<Sub62ClientBurstBeginEventCommand_Serializer, Sub62ClientBurstBeginEventCommand>
	{
		/// <summary>
