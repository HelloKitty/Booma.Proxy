...
namespace Booma.Proxy
{
    ...
    public partial class Sub62PhotonChairCommand
    {
        ...
        {
            Sub62PhotonChairCommand_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(BaseSubCommand62 value, Span<byte> buffer, ref int offset)
        {
            Sub62PhotonChairCommand_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// </summary>
    public sealed partial class Sub62PhotonChairCommand_AutoGeneratedTemplateSerializerStrategy
        : BaseAutoGeneratedSerializerStrategy<Sub62PhotonChairCommand_AutoGeneratedTemplateSerializerStrategy, Sub62PhotonChairCommand>
    {
        /// <summary>
