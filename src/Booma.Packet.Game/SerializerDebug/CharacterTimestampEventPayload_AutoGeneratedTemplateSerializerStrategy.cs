...
namespace Booma.Proxy
{
    ...
    public partial class CharacterTimestampEventPayload
    {
        public override Type SerializableType => typeof(CharacterTimestampEventPayload);
        public override PSOBBGamePacketPayloadServer Read(Span<byte> buffer, ref int offset)
        {
            CharacterTimestampEventPayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(PSOBBGamePacketPayloadServer value, Span<byte> buffer, ref int offset)
        {
            CharacterTimestampEventPayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// code for the Type: <see cref="CharacterTimestampEventPayload"/>
    /// </summary>
    public sealed partial class CharacterTimestampEventPayload_AutoGeneratedTemplateSerializerStrategy
        : BaseAutoGeneratedSerializerStrategy<CharacterTimestampEventPayload_AutoGeneratedTemplateSerializerStrategy, CharacterTimestampEventPayload>
    {
        /// <summary>
        ...
        public override void InternalRead(CharacterTimestampEventPayload value, Span<byte> buffer, ref int offset)
        {
        ...
        /// <param name="buffer">See external doc.</param>
        /// <param name="offset">See external doc.</param>
        public override void InternalWrite(CharacterTimestampEventPayload value, Span<byte> buffer, ref int offset)
        {
            //Type: PSOBBGamePacketPayloadServer Field: 1 Name: OperationCode Type: GameNetworkOperationCode;
