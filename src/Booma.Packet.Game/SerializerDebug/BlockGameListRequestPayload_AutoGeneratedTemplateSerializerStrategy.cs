...
namespace Booma.Proxy
{
    ...
    public partial class BlockGameListRequestPayload
    {
        ...
        {
            BlockGameListRequestPayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(PSOBBGamePacketPayloadClient value, Span<byte> buffer, ref int offset)
        {
            BlockGameListRequestPayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// </summary>
    public sealed partial class BlockGameListRequestPayload_AutoGeneratedTemplateSerializerStrategy
            : BaseAutoGeneratedSerializerStrategy<BlockGameListRequestPayload_AutoGeneratedTemplateSerializerStrategy, BlockGameListRequestPayload>
    {
        /// <summary>
