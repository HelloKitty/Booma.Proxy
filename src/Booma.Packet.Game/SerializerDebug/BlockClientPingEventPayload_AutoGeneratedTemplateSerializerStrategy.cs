...
namespace Booma.Proxy
{
    ...
    public partial class BlockClientPingEventPayload
    {
        ...
        {
            BlockClientPingEventPayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(PSOBBGamePacketPayloadServer value, Span<byte> buffer, ref int offset)
        {
            BlockClientPingEventPayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// </summary>
    public sealed partial class BlockClientPingEventPayload_AutoGeneratedTemplateSerializerStrategy
        : BaseAutoGeneratedSerializerStrategy<BlockClientPingEventPayload_AutoGeneratedTemplateSerializerStrategy, BlockClientPingEventPayload>
    {
        /// <summary>
