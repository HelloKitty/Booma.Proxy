...
namespace Booma.Proxy
{
    ...
    public partial class BlockLobbyChangeRequestPayload
    {
        public override Type SerializableType => typeof(BlockLobbyChangeRequestPayload);
        public override PSOBBGamePacketPayloadClient Read(Span<byte> buffer, ref int offset)
        {
            BlockLobbyChangeRequestPayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(PSOBBGamePacketPayloadClient value, Span<byte> buffer, ref int offset)
        {
            BlockLobbyChangeRequestPayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// code for the Type: <see cref="BlockLobbyChangeRequestPayload"/>
    /// </summary>
    public sealed partial class BlockLobbyChangeRequestPayload_AutoGeneratedTemplateSerializerStrategy
            : BaseAutoGeneratedSerializerStrategy<BlockLobbyChangeRequestPayload_AutoGeneratedTemplateSerializerStrategy, BlockLobbyChangeRequestPayload>
    {
        /// <summary>
        ...
        public override void InternalRead(BlockLobbyChangeRequestPayload value, Span<byte> buffer, ref int offset)
        {
            ...
            //Type: BlockLobbyChangeRequestPayload Field: 1 Name: Selection Type: MenuItemIdentifier;
        ...
        /// <param name="buffer">See external doc.</param>
        /// <param name="offset">See external doc.</param>
        public override void InternalWrite(BlockLobbyChangeRequestPayload value, Span<byte> buffer, ref int offset)
        {
            //Type: PSOBBGamePacketPayloadClient Field: 1 Name: OperationCode Type: GameNetworkOperationCode;
