...
namespace Booma.Proxy
{
    ...
    public partial class CharacterGuildHeaderRequestPayload
    {
        public override Type SerializableType => typeof(CharacterGuildHeaderRequestPayload);
        public override PSOBBGamePacketPayloadClient Read(Span<byte> buffer, ref int offset)
        {
            CharacterGuildHeaderRequestPayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(PSOBBGamePacketPayloadClient value, Span<byte> buffer, ref int offset)
        {
            CharacterGuildHeaderRequestPayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// code for the Type: <see cref="CharacterGuildHeaderRequestPayload"/>
    /// </summary>
    public sealed partial class CharacterGuildHeaderRequestPayload_AutoGeneratedTemplateSerializerStrategy
        : BaseAutoGeneratedSerializerStrategy<CharacterGuildHeaderRequestPayload_AutoGeneratedTemplateSerializerStrategy, CharacterGuildHeaderRequestPayload>
    {
        /// <summary>
        ...
        public override void InternalRead(CharacterGuildHeaderRequestPayload value, Span<byte> buffer, ref int offset)
        {
        ...
        /// <param name="buffer">See external doc.</param>
        /// <param name="offset">See external doc.</param>
        public override void InternalWrite(CharacterGuildHeaderRequestPayload value, Span<byte> buffer, ref int offset)
        {
            //Type: PSOBBGamePacketPayloadClient Field: 1 Name: OperationCode Type: GameNetworkOperationCode;
