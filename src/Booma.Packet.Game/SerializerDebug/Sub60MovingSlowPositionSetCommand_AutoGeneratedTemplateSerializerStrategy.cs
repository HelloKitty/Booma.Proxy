...
namespace Booma.Proxy
{
    ...
    public partial class Sub60MovingSlowPositionSetCommand
    {
        public override Type SerializableType => typeof(Sub60MovingSlowPositionSetCommand);
        public override BaseSubCommand60 Read(Span<byte> buffer, ref int offset)
        {
            Sub60MovingSlowPositionSetCommand_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(BaseSubCommand60 value, Span<byte> buffer, ref int offset)
        {
            Sub60MovingSlowPositionSetCommand_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// code for the Type: <see cref="Sub60MovingSlowPositionSetCommand"/>
    /// </summary>
    public sealed partial class Sub60MovingSlowPositionSetCommand_AutoGeneratedTemplateSerializerStrategy
            : BaseAutoGeneratedSerializerStrategy<Sub60MovingSlowPositionSetCommand_AutoGeneratedTemplateSerializerStrategy, Sub60MovingSlowPositionSetCommand>
    {
        /// <summary>
        ...
        public override void InternalRead(Sub60MovingSlowPositionSetCommand value, Span<byte> buffer, ref int offset)
        {
            ...
            //Type: Sub60MovingSlowPositionSetCommand Field: 1 Name: Identifier Type: Byte;
            value.Identifier = BytePrimitiveSerializerStrategy.Instance.Read(buffer, ref offset);
            //Type: Sub60MovingSlowPositionSetCommand Field: 2 Name: unk1 Type: Byte;
        ...
        /// <param name="buffer">See external doc.</param>
        /// <param name="offset">See external doc.</param>
        public override void InternalWrite(Sub60MovingSlowPositionSetCommand value, Span<byte> buffer, ref int offset)
        {
            //Type: BaseSubCommand60 Field: 1 Name: CommandOperationCode Type: SubCommand60OperationCode;
