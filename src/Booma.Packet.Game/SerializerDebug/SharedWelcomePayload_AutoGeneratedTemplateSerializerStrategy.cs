...
namespace Booma.Proxy
{
    ...
    public partial class SharedWelcomePayload
    {
        ...
        {
            SharedWelcomePayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(PSOBBGamePacketPayloadServer value, Span<byte> buffer, ref int offset)
        {
            SharedWelcomePayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// </summary>
    public sealed partial class SharedWelcomePayload_AutoGeneratedTemplateSerializerStrategy
            : BaseAutoGeneratedSerializerStrategy<SharedWelcomePayload_AutoGeneratedTemplateSerializerStrategy, SharedWelcomePayload>
    {
        /// <summary>
