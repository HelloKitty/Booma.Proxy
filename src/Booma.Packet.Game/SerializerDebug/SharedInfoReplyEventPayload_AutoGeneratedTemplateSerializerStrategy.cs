...
namespace Booma.Proxy
{
    ...
    public partial class SharedInfoReplyEventPayload
    {
        public override Type SerializableType => typeof(SharedInfoReplyEventPayload);
        public override PSOBBGamePacketPayloadServer Read(Span<byte> buffer, ref int offset)
        {
            SharedInfoReplyEventPayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(PSOBBGamePacketPayloadServer value, Span<byte> buffer, ref int offset)
        {
            SharedInfoReplyEventPayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// code for the Type: <see cref="SharedInfoReplyEventPayload"/>
    /// </summary>
    public sealed partial class SharedInfoReplyEventPayload_AutoGeneratedTemplateSerializerStrategy
            : BaseAutoGeneratedSerializerStrategy<SharedInfoReplyEventPayload_AutoGeneratedTemplateSerializerStrategy, SharedInfoReplyEventPayload>
    {
        /// <summary>
        ...
        public override void InternalRead(SharedInfoReplyEventPayload value, Span<byte> buffer, ref int offset)
        {
        ...
        /// <param name="buffer">See external doc.</param>
        /// <param name="offset">See external doc.</param>
        public override void InternalWrite(SharedInfoReplyEventPayload value, Span<byte> buffer, ref int offset)
        {
            //Type: PSOBBGamePacketPayloadServer Field: 1 Name: OperationCode Type: GameNetworkOperationCode;
