...
namespace FreecraftCore.Serializer
{
    ...
    /// </summary>
    public sealed partial class CharacterInventoryData_AutoGeneratedTemplateSerializerStrategy
            : BaseAutoGeneratedSerializerStrategy<CharacterInventoryData_AutoGeneratedTemplateSerializerStrategy, CharacterInventoryData>
    {
        /// <summary>
        ...
        public override void InternalRead(CharacterInventoryData value, Span<byte> buffer, ref int offset)
        {
            ...
            value.Items = FixedSizeComplexArrayTypeSerializerStrategy<InventoryItem_AutoGeneratedTemplateSerializerStrategy, InventoryItem, StaticTypedNumeric_Int32_30>.Instance.Read(buffer, ref offset);
        }
        ...
        public override void InternalWrite(CharacterInventoryData value, Span<byte> buffer, ref int offset)
        {
            ...
            //Type: CharacterInventoryData Field: 5 Name: Items Type: InventoryItem[];
            FixedSizeComplexArrayTypeSerializerStrategy<InventoryItem_AutoGeneratedTemplateSerializerStrategy, InventoryItem, StaticTypedNumeric_Int32_30>.Instance.Write(value.Items, buffer, ref offset);
        }
