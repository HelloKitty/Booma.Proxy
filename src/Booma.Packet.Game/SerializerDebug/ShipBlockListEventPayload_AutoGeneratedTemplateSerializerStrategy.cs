...
namespace Booma.Proxy
{
    ...
    public partial class ShipBlockListEventPayload
    {
        ...
        {
            ShipBlockListEventPayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(PSOBBGamePacketPayloadServer value, Span<byte> buffer, ref int offset)
        {
            ShipBlockListEventPayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// </summary>
    public sealed partial class ShipBlockListEventPayload_AutoGeneratedTemplateSerializerStrategy
        : BaseAutoGeneratedSerializerStrategy<ShipBlockListEventPayload_AutoGeneratedTemplateSerializerStrategy, ShipBlockListEventPayload>
    {
        /// <summary>
