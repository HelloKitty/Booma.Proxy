...
namespace Booma.Proxy
{
    ...
    public partial class BlockGamePlayerJoinedEventPayload
    {
        public override Type SerializableType => typeof(BlockGamePlayerJoinedEventPayload);
        public override PSOBBGamePacketPayloadServer Read(Span<byte> buffer, ref int offset)
        {
            BlockGamePlayerJoinedEventPayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(PSOBBGamePacketPayloadServer value, Span<byte> buffer, ref int offset)
        {
            BlockGamePlayerJoinedEventPayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// code for the Type: <see cref="BlockGamePlayerJoinedEventPayload"/>
    /// </summary>
    public sealed partial class BlockGamePlayerJoinedEventPayload_AutoGeneratedTemplateSerializerStrategy
            : BaseAutoGeneratedSerializerStrategy<BlockGamePlayerJoinedEventPayload_AutoGeneratedTemplateSerializerStrategy, BlockGamePlayerJoinedEventPayload>
    {
        /// <summary>
        ...
        public override void InternalRead(BlockGamePlayerJoinedEventPayload value, Span<byte> buffer, ref int offset)
        {
        ...
        /// <param name="buffer">See external doc.</param>
        /// <param name="offset">See external doc.</param>
        public override void InternalWrite(BlockGamePlayerJoinedEventPayload value, Span<byte> buffer, ref int offset)
        {
            //Type: PSOBBGamePacketPayloadServer Field: 1 Name: OperationCode Type: GameNetworkOperationCode;
