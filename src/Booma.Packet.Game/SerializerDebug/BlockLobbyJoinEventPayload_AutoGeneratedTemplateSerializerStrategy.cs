...
namespace Booma.Proxy
{
    ...
    public partial class BlockLobbyJoinEventPayload
    {
        ...
        {
            BlockLobbyJoinEventPayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(PSOBBGamePacketPayloadServer value, Span<byte> buffer, ref int offset)
        {
            BlockLobbyJoinEventPayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// </summary>
    public sealed partial class BlockLobbyJoinEventPayload_AutoGeneratedTemplateSerializerStrategy
            : BaseAutoGeneratedSerializerStrategy<BlockLobbyJoinEventPayload_AutoGeneratedTemplateSerializerStrategy, BlockLobbyJoinEventPayload>
    {
        /// <summary>
        ...
        public override void InternalRead(BlockLobbyJoinEventPayload value, Span<byte> buffer, ref int offset)
        {
            ...
            value.LobbyCharacterData = ComplexArrayTypeSerializerStrategy<CharacterJoinData_AutoGeneratedTemplateSerializerStrategy, CharacterJoinData>.Instance.Read(buffer, ref offset);
        }
        ...
        public override void InternalWrite(BlockLobbyJoinEventPayload value, Span<byte> buffer, ref int offset)
        {
            ...
            //Type: BlockLobbyJoinEventPayload Field: 10 Name: LobbyCharacterData Type: CharacterJoinData[];
            ComplexArrayTypeSerializerStrategy<CharacterJoinData_AutoGeneratedTemplateSerializerStrategy, CharacterJoinData>.Instance.Write(value.LobbyCharacterData, buffer, ref offset);
        }
