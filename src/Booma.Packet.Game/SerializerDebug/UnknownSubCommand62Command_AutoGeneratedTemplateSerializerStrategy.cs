...
namespace Booma.Proxy
{
    ...
    public partial class UnknownSubCommand62Command
    {
        ...
        {
            UnknownSubCommand62Command_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(BaseSubCommand62 value, Span<byte> buffer, ref int offset)
        {
            UnknownSubCommand62Command_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// </summary>
    public sealed partial class UnknownSubCommand62Command_AutoGeneratedTemplateSerializerStrategy
            : BaseAutoGeneratedSerializerStrategy<UnknownSubCommand62Command_AutoGeneratedTemplateSerializerStrategy, UnknownSubCommand62Command>
    {
        /// <summary>
