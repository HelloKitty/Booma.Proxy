...
namespace Booma.Proxy
{
    ...
    public partial class UnknownServerGamePayload
    {
        public override Type SerializableType => typeof(UnknownServerGamePayload);
        public override PSOBBGamePacketPayloadServer Read(Span<byte> buffer, ref int offset)
        {
            UnknownServerGamePayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(PSOBBGamePacketPayloadServer value, Span<byte> buffer, ref int offset)
        {
            UnknownServerGamePayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// code for the Type: <see cref="UnknownServerGamePayload"/>
    /// </summary>
    public sealed partial class UnknownServerGamePayload_AutoGeneratedTemplateSerializerStrategy
        : BaseAutoGeneratedSerializerStrategy<UnknownServerGamePayload_AutoGeneratedTemplateSerializerStrategy, UnknownServerGamePayload>
    {
        /// <summary>
        ...
        public override void InternalRead(UnknownServerGamePayload value, Span<byte> buffer, ref int offset)
        {
            ...
            //Type: UnknownServerGamePayload Field: 1 Name: UnknownBytes Type: Byte[];
        ...
        /// <param name="buffer">See external doc.</param>
        /// <param name="offset">See external doc.</param>
        public override void InternalWrite(UnknownServerGamePayload value, Span<byte> buffer, ref int offset)
        {
            //Type: PSOBBGamePacketPayloadServer Field: 1 Name: OperationCode Type: GameNetworkOperationCode;
