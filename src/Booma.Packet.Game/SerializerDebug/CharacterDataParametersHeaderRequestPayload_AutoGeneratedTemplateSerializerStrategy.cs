...
namespace Booma.Proxy
{
    ...
    public partial class CharacterDataParametersHeaderRequestPayload
    {
        public override Type SerializableType => typeof(CharacterDataParametersHeaderRequestPayload);
        public override PSOBBGamePacketPayloadClient Read(Span<byte> buffer, ref int offset)
        {
            CharacterDataParametersHeaderRequestPayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(PSOBBGamePacketPayloadClient value, Span<byte> buffer, ref int offset)
        {
            CharacterDataParametersHeaderRequestPayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// code for the Type: <see cref="CharacterDataParametersHeaderRequestPayload"/>
    /// </summary>
    public sealed partial class CharacterDataParametersHeaderRequestPayload_AutoGeneratedTemplateSerializerStrategy
        : BaseAutoGeneratedSerializerStrategy<CharacterDataParametersHeaderRequestPayload_AutoGeneratedTemplateSerializerStrategy, CharacterDataParametersHeaderRequestPayload>
    {
        /// <summary>
        ...
        public override void InternalRead(CharacterDataParametersHeaderRequestPayload value, Span<byte> buffer, ref int offset)
        {
        ...
        /// <param name="buffer">See external doc.</param>
        /// <param name="offset">See external doc.</param>
        public override void InternalWrite(CharacterDataParametersHeaderRequestPayload value, Span<byte> buffer, ref int offset)
        {
            //Type: PSOBBGamePacketPayloadClient Field: 1 Name: OperationCode Type: GameNetworkOperationCode;
