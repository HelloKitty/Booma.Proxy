...
namespace Booma.Proxy
{
    ...
    public partial class BlockClientPingResponsePayload
    {
        public override Type SerializableType => typeof(BlockClientPingResponsePayload);
        public override PSOBBGamePacketPayloadClient Read(Span<byte> buffer, ref int offset)
        {
            BlockClientPingResponsePayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(PSOBBGamePacketPayloadClient value, Span<byte> buffer, ref int offset)
        {
            BlockClientPingResponsePayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// code for the Type: <see cref="BlockClientPingResponsePayload"/>
    /// </summary>
    public sealed partial class BlockClientPingResponsePayload_AutoGeneratedTemplateSerializerStrategy
        : BaseAutoGeneratedSerializerStrategy<BlockClientPingResponsePayload_AutoGeneratedTemplateSerializerStrategy, BlockClientPingResponsePayload>
    {
        /// <summary>
        ...
        public override void InternalRead(BlockClientPingResponsePayload value, Span<byte> buffer, ref int offset)
        {
        ...
        /// <param name="buffer">See external doc.</param>
        /// <param name="offset">See external doc.</param>
        public override void InternalWrite(BlockClientPingResponsePayload value, Span<byte> buffer, ref int offset)
        {
            //Type: PSOBBGamePacketPayloadClient Field: 1 Name: OperationCode Type: GameNetworkOperationCode;
