...
namespace Booma.Proxy
{
	...
	public sealed class LoginClientPacketPayload : WireDataContractBaseLinkAttribute
	{
		public LoginClientPacketPayload(int index) 
			: base(index, typeof(LoginClientPacketPayload))
		{
