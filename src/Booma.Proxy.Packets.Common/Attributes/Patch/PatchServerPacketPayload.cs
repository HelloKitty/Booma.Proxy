...
namespace Booma.Proxy
{
	...
	public sealed class PatchServerPacketPayload : WireDataContractBaseLinkAttribute
	{
		public PatchServerPacketPayload(int index)
			: base(index, typeof(PatchServerPacketPayload))
		{
