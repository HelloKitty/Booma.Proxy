...
namespace Booma.Proxy
{
	...
	public sealed class PatchClientPacketPayload : WireDataContractBaseLinkAttribute
	{
		public PatchClientPacketPayload(int index) 
			: base(index, typeof(PatchClientPacketPayload))
		{
