...
namespace Booma.Proxy
{
	...
	/// </summary>
	public enum PatchNetworkOperationCode
	{
		...
		PACKET_HEADER_LENGTH            = 0x0004,
		PATCH_WELCOME_LENGTH            = 0x004C,
		PATCH_REDIRECT_LENGTH           = 0x000C,
		PATCH_REDIRECT6_LENGTH          = 0x0018,

		PATCH_FILE_SEND_LENGTH          = 0x003C,
		PATCH_DATA_SEND_LENGTH          = 0x0010,
		PATCH_FILE_DONE_LENGTH          = 0x0008,
		PATCH_SET_DIRECTORY_LENGTH      = 0x0044,
		PATCH_FILE_INFO_LENGTH          = 0x0028,
		PATCH_FILE_INFO_REPLY_LENGTH    = 0x0010,
		PATCH_SEND_INFO_LENGTH          = 0x000C,
	}
}
