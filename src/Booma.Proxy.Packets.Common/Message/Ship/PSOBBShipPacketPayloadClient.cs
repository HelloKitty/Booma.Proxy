...
{
	/// <summary>
	/// The base type for PSOBB ship packet payloads that the client sends. This isn't for patch/login.
	...
	public abstract class PSOBBShipPacketPayloadClient : IPacketPayload
	{
		/// <summary>
		...
		/// Flags will be 0.
		/// </summary>
		protected PSOBBShipPacketPayloadClient()
		{
		...
		protected PSOBBShipPacketPayloadClient([NotNull] byte[] flags)
		{
