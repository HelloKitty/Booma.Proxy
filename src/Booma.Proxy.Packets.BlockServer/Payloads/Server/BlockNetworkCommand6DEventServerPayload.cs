...
namespace Booma.Proxy
{
	...
	public class BlockNetworkCommand6DEventServerPayload : PSOBBGamePacketPayloadServer, ISub6DCommandContainer
	{
		/// <summary>
		/// The subcommand.
		/// </summary>
		...
		/// <inheritdoc />
		public BlockNetworkCommand6DEventServerPayload([JetBrains.Annotations.NotNull] BaseSubCommand6D command)
		{
