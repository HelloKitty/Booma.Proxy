...
namespace Booma.Proxy
{
	...
	public sealed class Sub60WarpToNewAreaPayload : BlockNetworkCommandEventClientPayload
	{
		/// <summary>
		...
		/// <inheritdoc />
		public Sub60WarpToNewAreaPayload(short clientId, int zone)
		{
		...
		private Sub60WarpToNewAreaPayload()
		{
